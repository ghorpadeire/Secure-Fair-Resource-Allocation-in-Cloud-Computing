		...
		<div class="article">
			...
			<div class="content">
						...
						<table width="40%" align="center"
							style="border: 1px; width: 40%; text-align: center; border: 1px solid">
							<tr>
							...
							<td style="text-align: center; border: 1px solid"><%=uname%>
								...
								<% }else if(usertype.equals("CRS User")){
								%>	
								<td style="text-align: center; border: 1px solid" ><a
									href="download?type=user&id=<%=id%>&file=<%=filename%>">Download
										File</a>&nbsp;</td>	
								<% 	
								}else if(usertype.equals("CRS Receiver") && (privi.equals("BOTH") || privi.equals("Download"))){
									%>	
									<td style="text-align: center; border: 1px solid" ><a
										href="download?type=rec&id=<%=id%>&file=<%=filename%>">Download
											File</a>&nbsp;</td>	
									<% 	
									}		
							%>	
